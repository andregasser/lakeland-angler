...
asset_ids:
  - "FISH-BLUEGILL-001"
  - "DIAGRAM-BLUEGILL-HABITAT-001"
---

# Sonnenbarsch (Bluegill)
...
| --- | --- | --- | --- |
| Frühjahr bis Sommer | erste 2 Stunden nach Sonnenaufgang; letzte 2 vor Sonnenuntergang | Wurm oder Cricket | sehr gut; mildes Panfish-Fleisch |

## Erkennen

- Hoher, seitlich abgeflachter „Bream“-Körper mit langer Rückenflosse
- Dunkler, vollständig schwarzer Kiemendeckellappen ohne roten Rand
- Dunkler Fleck am hinteren unteren Ende der Rückenflosse

**Verwechslung:** Redear Sunfish trägt am hinteren Rand des Kiemendeckellappens eine auffällige rote bis orange Markierung. Beim Bluegill fehlt dieser farbige Saum.
...
1. Suche klare Sandstellen, Vegetationskanten oder Schatten an Stegen und Holz.
2. Biete einen Wurm oder ein Cricket am Grund oder unter einer feinen Pose an.
3. Bleiben Bisse aus, verändere zuerst Tiefe und Abstand zur Struktur; wechsle erst danach den Köder.
...
- **Versorgung:** Art, Gewässerregel und aktuellen Verzehrhinweis prüfen. Entnommenen Fisch sofort kalt halten. Bluegill zählt zum gemeinsamen Panfish-Limit; Sonderregeln können strenger sein.
- **Küche:** Das milde Fleisch eignet sich für kleine Pfannenfilets oder ganze, küchenfertig vorbereitete Fische. Im dicksten Bereich mindestens 63 °C erreichen.
- **Erfolgsrezept:** Florida Fish Tacos, Seite 57

> **Merksatz:** Finde Sand, Struktur und die richtige Tiefe – dann liefert ein kleiner Naturköder zuverlässig Bisse.

## Quick Reference

- Frühjahr bis Sommer
- Sandnester, Uferstruktur und Stege
- Wurm oder Cricket an Haken 6–8
- kleine Pose oder Grundmontage mit Split Shot
- bei ausbleibenden Bissen tiefer suchen
