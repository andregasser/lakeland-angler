...
- `Icons/`: neun SVG-Master beziehungsweise Iconsets mit PNG-Prüfexports
- `Fische/`: fünf freigestellte Zielfischillustrationen
- `Montagen/`: vier Montagen und zwei Knotendiagramme als SVG-Master mit PNG-Prüfexports
...
- neun Icons beziehungsweise Iconsets: gestalterisch zu prüfen
- fünf Zielfische: fertig und vom Herausgeber genehmigt
- vier Montagen und zwei Knotendiagramme: fachlich zu prüfen

Die Chroma-Key-Quellen und verworfenen Varianten unter `Assets/Proofs/` sind lokale Produktionshilfen und werden nicht versioniert.
